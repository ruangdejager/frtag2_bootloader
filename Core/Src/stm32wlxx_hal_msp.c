...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC_MspInit 0 */
    ...
    PA12     ------> ADC_IN8
    */
    GPIO_InitStruct.Pin = VSOLAR_MEAS_VOL_Pin|RSENSE_MEAS_VOLT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MEAS_BAT_VOLT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(MEAS_BAT_VOLT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC_MspDeInit 0 */
    ...
    PA12     ------> ADC_IN8
    */
    HAL_GPIO_DeInit(GPIOB, VSOLAR_MEAS_VOL_Pin|RSENSE_MEAS_VOLT_Pin);

    HAL_GPIO_DeInit(MEAS_BAT_VOLT_GPIO_Port, MEAS_BAT_VOLT_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = ACC_SCLK_Pin|ACC_SO_Pin|ACC_SI_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, ACC_SCLK_Pin|ACC_SO_Pin|ACC_SI_Pin);
